...
public class Figure24PathBBlueCommand extends SlalomCommandGroup {
    ...
    public Figure24PathBBlueCommand(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem) {
        ...
        new DeployIntakeCommand(intakeSubsystem),
                ...
                ,
                new AutoDriveCommand(6 * 12, 65, 25, 180, driveSubsystem)
                ,
                new AutoDriveCommand(1.5 * 12, 90, 25, 180, driveSubsystem)
                ,
                new AutoDriveCommand(5 * 12, 160, 25, 180, driveSubsystem)
                ,
                new AutoDriveCommand(2 * 12, 90, 25, 180, driveSubsystem),
                new AutoDriveCommand(5.5 * 12, 25, 25, 180, driveSubsystem),
