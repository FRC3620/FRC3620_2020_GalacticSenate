...
public class DriveSubsystem extends SubsystemBase {
  ...
  public final CANSparkMax rightFrontDriveMaster = RobotContainer.driveSubsystemRightFrontDrive;
	...
	private double RIGHT_FRONT_ABSOLUTE_OFFSET = -133;//119; // reading of the absolute encoders when the wheels are pointed at true 0 degrees (-180 to 180 degrees)
	private double LEFT_FRONT_ABSOLUTE_OFFSET = 14;//140;
	private double LEFT_BACK_ABSOLUTE_OFFSET = 59;//94;
	private double RIGHT_BACK_ABSOLUTE_OFFSET = -101;//50; 
